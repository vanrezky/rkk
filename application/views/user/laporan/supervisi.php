              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center">
                                    <a class="btn btn-success" href="<?php echo base_url('u_laporan/details/' . $single_supervisi->id_supervisi); ?>" title="view"><div style="font-size: 0.5rem;" style="margin-top: 10px">
                                        <i class="fa fa-eye"></i>
                                      </div>
                                    </a>
                                    ...
                                    <!-- <a class="btn btn-danger" href="<?php echo base_url('supervisi/delete/' . $single_supervisi->id_supervisi); ?>" onClick="return confirm('Anda yakin menghapus data Supervisi <?php echo $single_supervisi->nama_karyawan;?> ?');" title="Hapus"><div style="font-size: 0.5rem;">
                                        <i class="fa fa-trash"></i>
                                      </div>
                                    </a> -->
                                    <a class="btn btn-warning" href="<?php echo base_url('u_laporan/print/' . $single_supervisi->id_supervisi); ?>" title="Print" target="_blank"><div style="font-size: 0.5rem;">
