                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-3 col-md-2">
                      ...
                      <a href="<?php echo site_url('u_laporan/supervisi') ?>"><center><i class="fas fa-calendar" style="font-size:48px;color:#20b2aa"></i><center></a>          
                      </div>
                    </div>
                    <div class="col-sm-3 col-md-2">
                      ...
                      <div class="color-palette-set">
                      <a href="<?php echo site_url('U_laporan/penilaian') ?>"><center><i class="fa fa-check" style="font-size:48px;color:#20b2aa"></i><center></a>          
                      </div>
                    </div>              
                  </div>
                      &emsp;
