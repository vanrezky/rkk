  ...
  <section class="content">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Laporan Penilaian</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center">
                              ...
                              <a class="btn btn-warning" href="<?php echo base_url(); ?>penilaian/print/<?php echo $l['id_supervisi']; ?>" title="Print" target="_blank"><div style="font-size: 0.5rem;">
