              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center">
                                    <a class="btn btn-success" href="<?php echo base_url('laporan/details/' . $single_supervisi->id_supervisi); ?>" title="view"><div style="font-size: 0.5rem;" style="margin-top: 10px">
                                        <i class="fa fa-eye"></i>
                                      </div>
                                    </a>
