          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">
                ...
                <a style="margin-left: 5px;" href="<?php echo base_url('laporan/supervisi'); ?>" class="btn btn-warning float-right"><i class="fas fa-arrow-alt-circle-left"></i></i> Back</a>
                </h3>
                </div>
                    <div class="card-body">
                ...
                <div class="row no-print">
                    <div class="col-12">
                            ...
                            <a href="<?php echo base_url('supervisi/pdf/' . $supervisi_info->id_supervisi); ?>" target="_blank" class="btn btn-primary float-right"><i class="fas fa-download"></i> Generate PDF</a>
                        </div>
                    </div>
                </div>
            </div>
