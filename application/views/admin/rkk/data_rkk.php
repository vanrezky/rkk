      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <p align="left">
                <a href="<?php echo base_url(); ?>rkk/add" class="btn btn-primary"><i class="glyphicon glyphicon-plus glyphicon-white"></i> Tambah</a>
              </p>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center">
                                    <a class="btn btn-info" href="<?php echo base_url('rkk/edit/' . $single_rkk->id_rkk); ?>"><div style="font-size: 0.5rem;">
                                        <i class="fa fa-share"></i>  </div>
                                    </a>
                                    <a class="btn btn-danger" href="<?php echo base_url('rkk/delete/' . $single_rkk->id_rkk); ?>" onClick="return confirm('Anda yakin..???');" title="Hapus"><div style="font-size: 0.5rem;">
