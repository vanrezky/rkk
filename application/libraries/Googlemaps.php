...
class Googlemaps {
	...
	var $center						= "0.5137908,101.3711354";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	var $minzoom					= '12';						// The minimum zoom level which will be displayed on the map
	var $maxzoom					= '21';						// The maximum zoom level which will be displayed on the map
	...
	var $streetViewCloseButton		= TRUE;					// If set to TRUE will show the close button in the top right. The close button allows users to return to the aerial map
	...
	var $directionsWaypointsOptimize= TRUE;					// Should the waypoints be optimised? If TRUE, waypoints will be re-ordered to provide the most efficient route.
